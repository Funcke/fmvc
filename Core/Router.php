...
class Router 
{
     ...
     * Core\Environment\ProductionEnvironmentAdapter.
     * For testing usage, an instance of Core\Testing\TestEnvironmentAdapter is
     * recommended.
     * 
     * @var Core\Environment\EnvironmentAdapter
     */
    private $environment;
     ...
     * Constructor
     * 
     * @param Core\Environment\EnvironmentAdapter $environment - adapter providing all
     *                                                           necessary data from
     *                                                           the execution env.
     ...
     * 
     * @throws Core\RequestError - thrown if an HTTP Error is desired
     */
